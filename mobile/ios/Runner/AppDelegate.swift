...
@objc class AppDelegate: FlutterAppDelegate {
  ...
  public static func registerPlugins(with engine: FlutterEngine) {
    ...
    let uploadFlutterApi = UploadFlutterApi(binaryMessenger: engine.binaryMessenger)
    UploadApiSetup.setUp(binaryMessenger: engine.binaryMessenger, api: UploadApiImpl(flutterApi: uploadFlutterApi))
  }
